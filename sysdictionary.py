...
STRAPI_API_ENDPOINTS = {
    'SESSIONS': os.getenv('STRAPI_API_SESSION_ENDPOINT'),
    'OUTLETS': os.getenv('STRAPI_API_OUTLETS_ENDPOINT'),
}
SCRAPE_SESSION_SAVE_MODE = os.getenv('SCRAPE_SESSION_SAVE_MODE')
NER_TYPES = {
